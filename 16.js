...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    return {
      fields: [{
        ...
        formatter: function formatter(value, key, item) {
          ...
          var dut0 = _this._.get(item, 'exec.duts.0', defValue);

          return "".concat(dut0.vendor, "-").concat(dut0.model);
        }
      }, {
        key: 'exec.sut',
        sortable: false,
        ...
        formatter: function formatter(value, key, item) {
          ...
          var sut = _this._.get(item, 'exec.sut', defValue);

          return "".concat(sut.branch, "/").concat(sut.commitId.substr(0, 7));
        }
      }],
  ...
  methods: {
    ...
    _getList: function _getList() {
      ...
      return Object(_api_results__WEBPACK_IMPORTED_MODULE_1__["resultsList"])(countQuery).then(function (_ref) {
        var data = _ref.data;
        _this2.total = data.count;
        return Object(_api_results__WEBPACK_IMPORTED_MODULE_1__["resultsList"])(query);
      }).then(function (_ref2) {
        var data = _ref2.data;
        return data;
      }).catch(function (error) {
        console.error(error);
        _this2.total = 0; // Returning an empty array, allows table to correctly handle
